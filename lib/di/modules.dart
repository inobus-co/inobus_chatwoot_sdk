...
import 'package:inobus_chatwoot_sdk/data/local/dao/chatwoot_conversation_dao.dart';
import 'package:inobus_chatwoot_sdk/data/local/dao/chatwoot_messages_dao.dart';
...
final unauthenticatedDioProvider = Provider.family
    .autoDispose<Dio, ChatwootParameters>((ref, params) {
      ...
      dio.interceptors.addAll(params.dioInterceptors);
      return dio;
    });
...
final authenticatedDioProvider = Provider.family
    .autoDispose<Dio, ChatwootParameters>((ref, params) {
      ...
      authenticatedDio.interceptors.addAll(params.dioInterceptors);
